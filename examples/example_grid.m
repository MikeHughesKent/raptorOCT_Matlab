...
%
% Used to generate elements of Figure 4 of
%    Marques et al.,
...
% Filenames
filename = '..\example data\grid\example_grid_OCT.tif';
fluorFilename = '..\example data\grid\example_grid_fluor.tif';
enFaceOutFilename = '..\output\grid_enface.tif';
fluorOutFilename = '..\output\grid_fluorescence.tif';
volOutFilename = '..\output\grid_volume.tif';
startIm = 1;    
endIm = -1;              %-1 means all
...
enFace = enface_from_volume(volume, surfaceHeight + depth);
...
% save_volume_16bit(volume, volOutFilename);
